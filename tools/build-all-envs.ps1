...
param(
    [string[]] $Environments = @("field_passive", "field_passive_nowifi", "bench_active_ble", "chip_lab_active"),
    [string] $PlatformIo = "C:\Users\ezabz\.platformio\penv\Scripts\platformio.exe"
)
