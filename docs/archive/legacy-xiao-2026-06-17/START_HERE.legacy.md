...
Last updated: 2026-06-16 - Rev A first-article board arrival photos and physical review added
...
Rev A first-article boards arrived on 2026-06-16. Photos are archived under `photos/rev-a-first-article-2026-06-16/` and reviewed in `docs/rev-a-first-article-2026-06-16.md`. Treat Rev A as bench electrical bring-up hardware, not the product-form layout: the received assembly is visually massive, the functional KiCad outline is still 100 x 56 mm, the USB-C receptacle opening faces inward toward the board instead of outward toward a serviceable edge, and the owner confirmed USB-C is not really accessible. Use the TP1-TP9 test-pad row for bench service/recovery instead of forcing USB-C. Rev B needs a real mechanical/package revision.

Rev B ordering is blocked until `docs/rev-b-quality-gate-2026-06-16.md` is satisfied. The new physical layout gate is `tools/check-rev-b-layout-gates.ps1`; it checks board size, exact footprint-center overlaps, test-pad access, required test-pad nets, and requires a USB service-access proof artifact.
...
docs/rev-a-first-article-2026-06-16.md     Rev A received-board photos, physical review, and Rev B layout direction
docs/rev-b-quality-gate-2026-06-16.md      Mandatory Rev B physical/layout quality gate before ordering
